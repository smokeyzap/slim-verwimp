...
class ProfitMarginController extends Controller
{
    ...
    {   
        $data = Article::select(DB::raw("group_concat(distinct(group_name)) as group_name, group_concat(distinct(sub_group)) as sub_group, group_concat(distinct(title)) as title"))
